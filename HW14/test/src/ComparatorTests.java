...
public class ComparatorTests {
    ...
    public void codeGetChildrenAlphabeticalSortTest(){
        code.getChildren((APFSElement o1, APFSElement o2)->o1.getName().compareTo(o2.getName()));
    ...
    public void codeGetFilesRevAlphabeticalSortTest(){
        String[] expected = {"d","c"};
        assertArrayEquals(expected, fLinkedListToArray(code.getFiles((APFSElement o1, APFSElement o2)->o2.getName().compareTo(o1.getName()))));
    }
    @Test
    public void rootGetSubdirTimeStampSortTest(){
        String[] expected = {"applications","home"};
        assertArrayEquals(expected, dLinkedListToArray(root.getSubDirectories((APFSElement o1, APFSElement o2)->o2.getLastModified().compareTo(o1.getLastModified()))));
